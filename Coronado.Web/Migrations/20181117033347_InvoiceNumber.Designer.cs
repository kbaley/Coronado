            ...
            modelBuilder.Entity("Coronado.Web.Domain.Category", b =>
                {
                    ...
                    b.HasData(
                        new { CategoryId = new Guid("34a68d22-94b9-44db-ba85-723ba584703e"), Name = "Starting Balance", Type = "Income" },
                        new { CategoryId = new Guid("090b7359-1f60-4727-a109-f798d5fcfd11"), Name = "Bank Fees", Type = "Expense" }
                    );
                });
