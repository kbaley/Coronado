...
namespace Coronado.Web.Migrations
{
    ...
    [Migration("20190311222404_InvoicePaid")]
    partial class InvoicePaid
    {
            ...
            modelBuilder.Entity("Coronado.Web.Domain.Category", b =>
                {
                    ...
                    b.HasData(
                        new { CategoryId = new Guid("1eddf2b0-af78-4175-9bad-58197581a587"), Name = "Starting Balance", Type = "Income" },
                        new { CategoryId = new Guid("a55b035b-d1c9-4e20-a2b2-658c36f3584b"), Name = "Bank Fees", Type = "Expense" }
                    );
                });
